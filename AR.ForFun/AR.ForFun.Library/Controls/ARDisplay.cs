...
using System.IO;
using AR.ForFun.Library.Controls;
...
namespace GART.Controls
{
    ...
    public class ARDisplay : Grid, IARItemsView
    {
        ...
        private async void StartCamera()
        {
            ...
            //byteBuffer = new byte[(int)photoCaptureDevice.PreviewResolution.Width * (int)photoCaptureDevice.PreviewResolution.Height * 4];
            //frameBuffer = byteBuffer.AsBuffer();
        ...
        public ObservableCollection<LiveFilter> Filters
        {
            get
            {
                return (ObservableCollection<LiveFilter>)GetValue(FiltersProperty);
            }
            set
            {
